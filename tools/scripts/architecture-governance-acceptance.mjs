...
import { resolvePackablePlugin } from "./resolve-staged-plugin.mjs";
...
function stagedPlugin(id) {
  // Pack-safe mirrors only — never raw plugins/ with file:vendor deps.
  return resolvePackablePlugin(id, root, { stageMissing: true });
}
